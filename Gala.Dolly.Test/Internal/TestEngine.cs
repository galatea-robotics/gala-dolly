...
namespace Gala.Dolly.Test
{
    ...
    internal class TestEngine : RuntimeEngine, IRuntimeEngine, IEngine
    {
        #region Config
#if NETFX_CORE
        private static Gala.Data.Configuration.UWPSettings config;
        internal static Gala.Data.Configuration.UWPSettings UWPSettings { get { return config; } }
#endif
        ...
        {
#if NETFX_CORE
            config = Gala.Data.Configuration.UWPSettings.Load().Result;
        ...
        internal void Initialize()
        {
            ...
            this.User = new Galatea.Runtime.Services.User(defaultUserName);
            IChatbotManager chatbots = new Gala.Dolly.Test.ChatbotManager();
            robot.LanguageModel.LoadChatBots(chatbots);

            System.Collections.Generic.List<string> substitutions = new System.Collections.Generic.List<string>();
